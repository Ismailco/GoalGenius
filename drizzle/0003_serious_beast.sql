...
DROP TABLE `practitioners`;--> statement-breakpoint
...
INSERT INTO `__new_subscriptions`("id", "user_id", "plan", "started_at", "expires_at") SELECT "id", "user_id", "plan", "started_at", "expires_at" FROM `subscriptions`;--> statement-breakpoint
